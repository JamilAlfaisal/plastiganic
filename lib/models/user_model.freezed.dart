...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GeoLocation&&(identical(other.geopoint, geopoint) || other.geopoint == geopoint)&&(identical(other.geohash, geohash) || other.geohash == geohash));
}
...
mixin _$UserModel {
 ...
 String get id; String get role;// 'generator' | 'company'
 String get displayName; String? get photoUrl; String get phone; String get email; GeoLocation get location; String get languagePref;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get lastActiveAt; double get trustScore; bool get isVerified;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,role,displayName,photoUrl,phone,email,location,languagePref,createdAt,lastActiveAt,trustScore,isVerified);

@override
String toString() {
  return 'UserModel(id: $id, role: $role, displayName: $displayName, photoUrl: $photoUrl, phone: $phone, email: $email, location: $location, languagePref: $languagePref, createdAt: $createdAt, lastActiveAt: $lastActiveAt, trustScore: $trustScore, isVerified: $isVerified)';
}
...
@useResult
$Res call({
 String id, String role, String displayName, String? photoUrl, String phone, String email, GeoLocation location, String languagePref,@TimestampConverter() DateTime createdAt,@TimestampConverter() DateTime lastActiveAt, double trustScore, bool isVerified
});
...
/// Create a copy of UserModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? role = null,Object? displayName = null,Object? photoUrl = freezed,Object? phone = null,Object? email = null,Object? location = null,Object? languagePref = null,Object? createdAt = null,Object? lastActiveAt = null,Object? trustScore = null,Object? isVerified = null,}) {
  return _then(_self.copyWith(
...
as GeoLocation,languagePref: null == languagePref ? _self.languagePref : languagePref // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String role,  String displayName,  String? photoUrl,  String phone,  String email,  GeoLocation location,  String languagePref, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime lastActiveAt,  double trustScore,  bool isVerified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.role,_that.displayName,_that.photoUrl,_that.phone,_that.email,_that.location,_that.languagePref,_that.createdAt,_that.lastActiveAt,_that.trustScore,_that.isVerified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String role,  String displayName,  String? photoUrl,  String phone,  String email,  GeoLocation location,  String languagePref, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime lastActiveAt,  double trustScore,  bool isVerified)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
return $default(_that.id,_that.role,_that.displayName,_that.photoUrl,_that.phone,_that.email,_that.location,_that.languagePref,_that.createdAt,_that.lastActiveAt,_that.trustScore,_that.isVerified);case _:
  throw StateError('Unexpected subclass');
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.role, required this.displayName, this.photoUrl, required this.phone, required this.email, required this.location, this.languagePref = 'en', @TimestampConverter() required this.createdAt, @TimestampConverter() required this.lastActiveAt, this.trustScore = 100.0, this.isVerified = false});
...
/// Create a copy of UserModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? role = null,Object? displayName = null,Object? photoUrl = freezed,Object? phone = null,Object? email = null,Object? location = null,Object? languagePref = null,Object? createdAt = null,Object? lastActiveAt = null,Object? trustScore = null,Object? isVerified = null,}) {
